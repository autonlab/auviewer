...
def main():
    ...
    sources_and_destinations = [
        ['template_sources.builtin_default_project_template', f'{config.auvCodeRoot}/static/www/js/builtin_templates/builtin_default_project_template.json'],
        ['template_sources.builtin_default_interface_templates', f'{config.auvCodeRoot}/static/www/js/builtin_templates/builtin_default_interface_templates.json']#,
