...
__all__ = ['getProject', 'getProjects', 'listAvailableProjects', 'listProjects', 'loadProject', 'loadProjects', 'setDataPath']
...
def getProjects() -> Dict[int, Project]:
    ...
    :returns: dict mapped from project ID to project instance of all loaded projects
    """
    global loadedProjects
