<template>
    <div v-observe-visibility="onVisible">
        <b-form @submit="onSubmit">
            <b-form-group id="input-group-1" class="add-style">
                <label style="font-weight: 500">Annotation ID</label>
                <b-form-input id="input-1" v-model="annotationID" readonly></b-form-input>
            </b-form-group>
            <b-form-group id="input-group-2" class="add-style">
                <label style="font-weight: 500">File</label>
                <b-form-input id="input-2" v-model="annotationFile" readonly></b-form-input>
            </b-form-group>
            <b-form-group id="input-group-3" class="add-style">
                <label style="font-weight: 500">Series</label>
                <b-form-input id="input-3" v-model="annotationSeries" readonly></b-form-input>
            </b-form-group>
            <div v-for="(annotationFieldInput, index) in annotationFormInputs" :key="index">
                <annotation-field-component v-model="annotationResult[annotationFieldInput.id]" :field-info="annotationFieldInput">
                </annotation-field-component>
            </div>
            <b-form-row class="mb-2">
                <div class="col">
                    <b-form-group id="input-group-4" class="add-style">
                        <label style="font-weight: 500">Start time</label>
                        <b-input-group>
                            <b-form-input id="input-4" v-model="startDateText" type="date"></b-form-input>
                        </b-input-group>
                    </b-form-group>
                    <b-form-group id="input-group-6">
                        <b-input-group>
                            <b-form-input id="input-6" v-model="startTimeText" type="time" step=".001"></b-form-input>
                        </b-input-group>
                    </b-form-group>
                ...
                <div class="col">
                    ...
                    <b-form-group id="input-group-5" class="add-style">
                        <label style="font-weight: 500">End time</label>
                        <b-input-group>
                            <b-form-input id="input-5" v-model="endDateText" type="date"></b-form-input>
                        </b-input-group>
                    </b-form-group>
                    <b-form-group id="input-group-7">
                        <b-input-group>
                            <b-form-input id="input-7" v-model="endTimeText" type="time" step=".001"></b-form-input>
                        </b-input-group>
                    </b-form-group>
                </div>
            </b-form-row>
...
<script lang="ts">
import { Annotation, AnnotationField, AnnotationFormInput, AnnotationFieldType, CategoryOption } from '@/types';
...
export default class AnnotationModal extends Vue {
    ...
    populateFormModel(annotationfields: Array < AnnotationField > ) {
        this.annotationFormInputs = new Array < AnnotationFormInput > ();
        // this.annotationResult = {};
        for (let annotationField of annotationfields) {
            let defaultVal: string = annotationField.default ? annotationField.default : "";
            console.log(defaultVal);
            if (annotationField.type == AnnotationFieldType.Categorical) {
                if (!annotationField.classes) {
                    continue;
                }
                Vue.set(this.annotationResult, annotationField.id, defaultVal);
                ...
                this.annotationFormInputs.push({
                        ...
                        required: annotationField.required ? true : false,
